...
// ---------------------------------------------------------------------------
// VENDORED FROM GOOGLE TINK (tink-java v1.19.0), Apache-2.0.
// Source: https://github.com/tink-crypto/tink-java/blob/v1.19.0/src/main/java/com/google/crypto/tink/subtle/X25519.java
// Local modifications are listed in util/crypto/NOTICE.md; do not "clean up"
// the arithmetic below -- it is audited constant-time code, kept verbatim.
// Why vendored: Android's native XDH KeyAgreement only exists from API 33 and
// this app's minSdk is 29, so X25519 has to come from pure Java.
// ---------------------------------------------------------------------------
 ...
 * <h3>Warning</h3>
 *
 * <p>Do not use this API or any other APIs including fields and methods marked with the  * annotation. They can be modified in any way, or even removed, at any time. They are in the
...
public final class X25519 {
  ...
  public static byte[] generatePrivateKey() {
    byte[] privateKey = randomBytes(Field25519.FIELD_LEN);
  ...
  /**
   * Local replacement for Tink's {@code Random.randBytes} (that helper lives in a Tink class we
   * don't vendor). {@link SecureRandom} is the platform CSPRNG the pairing design mandates.
   */
