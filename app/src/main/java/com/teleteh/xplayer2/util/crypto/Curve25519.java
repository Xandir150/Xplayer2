...
// Source: https://github.com/tink-crypto/tink-java/blob/v1.19.0/src/main/java/com/google/crypto/tink/internal/Curve25519.java
...
public final class Curve25519 {
  ...
  public static void curveMult(long[] resultx, byte[] n, byte[] qBytes) throws InvalidKeyException {
    ...
    if (!isCollinear(q, resultx, nqpqx, nqpqz)) {
      throw new IllegalStateException(
          "Arithmetic error in curve multiplication with the public key: " + hexEncode(qBytes));
    }
  }
  ...
  private static boolean isCollinear(long[] x1, long[] x2, long[] x3, long[] z3) {
    ...
    return MessageDigest.isEqual(Field25519.contract(lhs), Field25519.contract(t));
  }

  /**
   * Local replacement for Tink's {@code Hex.encode}; used only to render a key in an exception
   * message. Vendored so this file doesn't drag in the rest of Tink's subtle package.
   */
